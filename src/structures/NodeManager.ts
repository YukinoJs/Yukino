...
export class NodeManager extends EventEmitter {
  ...
  public nodeGroups: Map<string, NodeGroup> = new Map();
  private _nodeSelector: (nodes: Node[], guildId?: string) => Node | undefined = this._defaultNodeSelector;
   ...
   */
  public addNode(options: NodeOptions, connector: any): Node {
   ...
   */
  public addNodes(optionsArray: NodeOptions[], connector: any): Node[] {
   ...
   */
  private _defaultNodeSelector(nodes: Node[], guildId?: string): Node | undefined {
   ...
   */
  public getNodesByGroup(groupName: string): Node[] {
   ...
   */
  public selectNode(guildId?: string, nodeName?: string, groupName?: string): Node | undefined {
